...
* School of Maa
* Chris Sugrue
* Recap basics of working with pixels : iterate through image 
* pixels and threshold to set dark pixels as transparent.
*/
...
void setup(){
  ...
  myXImage = new PImage(myImage.width,myImage.height, ARGB);
...
void draw(){
  ...
  for( int i = 0; i < totalPixels; i++){
      ...
      if(pixelBrightness < 75) pixelColor=color(0,0,0,0);
